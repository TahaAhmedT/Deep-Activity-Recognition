...
def main():
    ...
    logger = setup_logger(
            log_file=__file__,
            log_dir=os.path.join(CONFIG["baseline7_logs"], "exp4"),
    ...
    finetune(log_dir=os.path.join(CONFIG["baseline7_logs"], "exp4"),
            ...
            metrics_logs="logs/training_logs/baseline7/exp4/b7_training.csv",
            preds_logs="logs/training_logs/baseline7/exp4/b7_test_predictions.csv",
            save_path="models/b7",
            crop=True,
    ...
    visualize(metrics_path="logs/training_logs/baseline7/exp4/b7_training.csv",
            ys_path="logs/training_logs/baseline7/exp4/b7_test_predictions.csv",
            save_path="assets/baselines_assets/baseline7/exp4",
            log_dir=os.path.join(CONFIG["baseline7_logs"], "exp4"),
            verbose=CONFIG["verbose"]
        )
