...
def main():
    ...
    logger = setup_logger(
            log_file=__file__,
            log_dir=os.path.join(CONFIG["baseline7_logs"], "exp1"),
    ...
    finetune(log_dir=os.path.join(CONFIG["baseline7_logs"], "exp1"),
            ...
            metrics_logs="logs/training_logs/baseline7/exp1/b7_training.csv",
            preds_logs="logs/training_logs/baseline7/exp1/b7_test_predictions.csv",
            save_path="models/b7_models/exp1",
            crop=True,
    ...
    visualize(metrics_path="logs/training_logs/baseline7/exp1/b7_training.csv",
            ys_path="logs/training_logs/baseline7/exp1/b7_test_predictions.csv",
            save_path="assets/baselines_assets/baseline7/exp1",
            log_dir=os.path.join(CONFIG["baseline7_logs"], "exp1"),
            verbose=CONFIG["verbose"]
        )
